...
def add_mean_min_max(metrics, experiment_data, key, metric_name):
    ...
    for e in experiment_data:
        metrics[metric_name]["average"].append(np.mean(e[key]))
...
def add_obstacle_clearance(metrics, experiment_data):
    ...
    add_mean_min_max(metrics, experiment_data, "obstacle_clearance", "obstacle_clearance")

def add_average_velocity(metrics, experiment_data):
    add_mean_min_max(metrics, experiment_data, "v", "velocity")
